...
public class TPRI_Populate_Data{
		...
		public void AssmentData(WebDriver driver ,String Title ,String Grade) throws InterruptedException{
			...
			AsmtTotalTargetStud =  AsmtData.findElement(By.xpath("tbody/tr[1]/td[9]/chiclet")).getText();
			...
			for (int i=0; i < TierColumnName.length; i++){				
				TierPercen[i] = AsmtData.findElement(By.xpath("tbody/tr[1]/td["+(i+12)+"]")).getText();
				TierValues[i] = Integer.parseInt(AsmtData.findElement(By.xpath("tbody/tr[1]/td["+(i+13)+"]/chiclet")).getText());
			...
			for (int i = 0 ; i<GroupColumnName.length; i=i+1){
				GroupPerc[i] = AsmtData.findElement(By.xpath("tbody/tr[1]/td["+(i+18)+"]")).getText();
				GroupValues[i] = Integer.parseInt(AsmtData.findElement(By.xpath("tbody/tr[1]/td["+(i+19)+"]/chiclet")).getText());
